...
//import PikachuGameboy from "../components/PikachuGameboy.jsx";
    ...
    return (
        <section className="min-h-screen w-full flex-col relative" id="home">
            <div className="w-full mx-auto flex-col sm:mt-36 mt-20 c-space gap-3">
                ...
                <p className="hero_tag text-gray_gradient">Coding My Imagination</p>
            </div>
                ...
                <Canvas className="w-full h-full">
                    <Suspense fallback={<CanvasLoader />}>
                        ...
                        <group>
                            ...
                            {/* <PikachuGameboy position={sizes.cubePosition} scale={1/4}/> */}
